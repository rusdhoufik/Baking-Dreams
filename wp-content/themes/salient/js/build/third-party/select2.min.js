...
! function(e) {
    ...
    var e, n, i, d, r, o, p, h, f, g, m, y, s, a, v, i = (t && t.fn && t.fn.select2 && t.fn.select2.amd && (u = t.fn.select2.amd), u && u.requirejs || (u ? n = u : u = {}, f = {}, g = {}, m = {}, y = {}, s = Object.prototype.hasOwnProperty, a = [].slice, v = /\.js$/, p = function(e, t) {
        var n, i, s = c(e),
            r = s[0];
        ...
        if (i = i || e, "undefined" == u || "function" == u) {
            for (t = !t.length && n.length ? ["require", "exports", "module"] : t, a = 0; a < t.length; a += 1)
                if ("require" === (r = (o = p(t[a], i)).f)) c[a] = h.require(e);
                else if ("exports" === r) c[a] = h.exports(e), l = !0;
            else if ("module" === r) s = c[a] = h.module(e);
            else if (_(f, r) || _(g, r) || _(y, r)) c[a] = b(r);
            else {
        ...
        return t = t || function() {}, "function" == typeof n && (n = i, i = s), i ? r(d, e, t, n) : setTimeout(function() {
            r(d, e, t, n)
        }, 4), o
    }, o.config = function(e) {
        return o(e)
        ...
        jQuery: !0
    }, u.requirejs = e, u.require = n, u.define = i), u.define("almond", function() {}), u.define("jquery", [], function() {
        var e = t || $;
        ...
        return e.prototype.bind = function(e, t, n) {
            ...
            e.call(this, t, n), t.on("*", function(e, t) {
                var n; - 1 !== o.inArray(e, s) && (t = t || {}, n = o.Event("select2:" + e, {
                    params: t
        ...
        return t.Extend(n, e), n.prototype.current = function(e) {
            ...
            this.$element.prop("multiple") ? this.current(function(e) {
                ...
                for (var n = 0; n < s.length; n++) {
                    var i = s[n].id; - 1 === o.inArray(i, t) && t.push(i)
                }
            ...
            return null != (e = o.extend({}, {
                text: ""
            }, e)).id && (e.id = e.id.toString()), null != e.text && (e.text = e.text.toString()), null == e._resultId && e.id && null != this.container && (e._resultId = this.generateResultId(this.container, e)), o.extend({}, {
                selected: !1,
                disabled: !1
            }, e)
        ...
        function e(e, t, n) {
            ...
            s = n.get("insertTag");
            if (s !== undefined && (this.insertTag = s), e.call(this, t, n), a.isArray(i))
        ...
        return e.prototype.bind = function(e, t, n) {
            ...
            for (var s = n.get("tokenSeparators") || [], r = t.term, o = 0, a = this.createTag || function(e) {
                ...
                var l = r[o]; - 1 !== c.inArray(l, s) ? (l = r.substr(0, o), null != (l = a(c.extend({}, t, {
                    term: l
    ...
    function l(e, t) {
        var n, i, s, r, o, a, l, c, u, d, p = t && t.split("/"),
            h = m.map,
            f = h && h["*"] || {};
        if (e && "." === e.charAt(0))
            if (t) {
